...
func New() *gin.Engine {
	...
	v1.GET("/image-upscale/capabilities", gin.WrapF(handler.ImageUpscaleCapabilities))
	v1.POST("/image-upscale/jobs", gin.WrapF(handler.CreateImageUpscaleJob))
	v1.GET("/image-upscale/jobs/:id", func(c *gin.Context) { handler.ImageUpscaleJob(c.Writer, c.Request, c.Param("id")) })
	v1.POST("/image-upscale/jobs/:id/retry", func(c *gin.Context) { handler.RetryImageUpscaleJob(c.Writer, c.Request, c.Param("id")) })
	v1.GET("/video-upscale/capabilities", gin.WrapF(handler.VideoUpscaleCapabilities))
	v1.POST("/video-upscale/jobs", gin.WrapF(handler.CreateVideoUpscaleJob))
	v1.GET("/video-upscale/jobs/:id", func(c *gin.Context) { handler.VideoUpscaleJob(c.Writer, c.Request, c.Param("id")) })
	v1.POST("/video-upscale/jobs/:id/retry", func(c *gin.Context) { handler.RetryVideoUpscaleJob(c.Writer, c.Request, c.Param("id")) })
	v1.GET("/video-subtitle-erase/capabilities", gin.WrapF(handler.VideoSubtitleEraseCapabilities))
	v1.POST("/video-subtitle-erase/jobs", gin.WrapF(handler.CreateVideoSubtitleEraseJob))
	v1.GET("/video-subtitle-erase/jobs/:id", func(c *gin.Context) { handler.VideoSubtitleEraseJob(c.Writer, c.Request, c.Param("id")) })
	v1.POST("/video-subtitle-erase/jobs/:id/retry", func(c *gin.Context) { handler.RetryVideoSubtitleEraseJob(c.Writer, c.Request, c.Param("id")) })
	...
	admin.POST("/settings/tencent-mps-video-test", gin.WrapF(handler.AdminTestTencentMPSVideo))
