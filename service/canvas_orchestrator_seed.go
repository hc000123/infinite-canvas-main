...
const (
	...
	canvasOrchestratorVersionID = "agent-version-system-canvas-orchestrator-1.0.0"
)
...
func EnsureCanvasOrchestratorSeed() error {
	...
	stamp := now()
	version := agentVersionFromPackage(canvasOrchestratorVersionID, canvasOrchestratorAgentID, "1.0.0", "system", stamp, packageValue)
