...
func EnsureWorkflowSkillSeeds() error {
	seeds := []workflowSkillSeed{
		...
		{WorkflowSkillStageStoryboard, "分镜提示词", "结合剧本和参考图片制作视频提示词。", "先理解输入图片中的人物外观、空间关系、光线和关键道具，再结合剧本制作结构化分镜与 Seedance 提示词；引用图片必须从 @图1 开始，并在 referenceEvidence 中逐图记录观察结果和应用位置。", "storyboard"},
