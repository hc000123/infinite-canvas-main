...
export function ImageBriefFormModal({
    ...
    return (
        <Modal rootClassName="studio-modal" title={editingBrief ? "编辑生图 Brief" : "手动补充需求"} open={open} onCancel={onCancel} onOk={() => form.submit()} okText="保存" cancelText="取消" width={760} destroyOnHidden>
