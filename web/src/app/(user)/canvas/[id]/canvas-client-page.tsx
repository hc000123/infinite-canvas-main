...
function InfiniteCanvasPage() {
    ...
    const { activeNodeId, assetById, frameReferencesByVideoId, selectedInspectorNode, selectedVideoNode, visibleNodes } = useCanvasDerivedState({
        assets,
        collapsingBatchIds,
        connections,
        containerRef,
    ...
    const { episodeProductionLabel, timelineShots, timelineShotGroups, activeTimelineNodeIds, productionPackages, productionPackageLabelMap, relatedHighlight } = useCanvasProductionWorkbenchState({
        canvasId,
        currentProject,
        creativeProject,
