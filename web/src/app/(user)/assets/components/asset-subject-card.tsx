    ...
    return (
        <article className="group min-w-0 overflow-hidden rounded-lg border border-[var(--studio-border-subtle)] bg-[var(--studio-elevated-bg)] transition hover:border-[var(--studio-accent)]">
            ...
            <div className="grid grid-cols-2 gap-1.5 border-t border-[var(--studio-border-subtle)] p-2">
                ...
                <Link href={`/assets/${subject.id}`} className="inline-flex h-8 items-center justify-center gap-1 rounded text-xs text-[var(--studio-text-secondary)] transition hover:bg-[var(--studio-hover-bg)] hover:text-[var(--studio-text-primary)]"><Sparkles className="size-3.5" />生成</Link>
