        ...
        <main className="studio-shell h-full min-h-0 overflow-y-auto px-4 py-5 md:px-6 xl:px-7">
            <div className="mx-auto max-w-5xl">
                <header className="border-b border-[var(--studio-border-subtle)] pb-6">
                    <h1 className="text-3xl font-semibold tracking-[-0.04em] text-[var(--studio-text-primary)]">资源库</h1>
                ...
                <section className="divide-y divide-[var(--studio-border-subtle)] border-b border-[var(--studio-border-subtle)]">
                    <Link href="/prompts" className="group flex items-center gap-4 py-5 text-left">
                    ...
                    <Link href="/cache" className="group flex items-center gap-4 py-5 text-left">
