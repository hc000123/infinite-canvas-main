...
function normalizeChannelCapabilities(value: string[] | undefined, protocol: AdminModelChannel["protocol"]) {
    const fallback = protocol === "volcengine-ark" ? ["text", "video"] : protocol === "jimeng-cli" ? ["video", "video_query", "preflight", "cli_workflow"] : protocol === "xinglian-cloud" ? ["video", "video_query", "preflight"] : protocol === "minimax" ? ["video", "video_query"] : ["text", "image"];
