...
export function useAdminUserDetail(userId: string) {
    ...
    return {
        ...
        isLoading: overview.isFetching || tasks.isFetching || creditLogs.isFetching || activities.isFetching || allowedIPs.isFetching || addIP.isPending || deleteIP.isPending || setPolicy.isPending,
    };
}
