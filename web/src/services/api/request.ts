...
import { emitAuthSessionInvalid } from "../auth-session-events.ts";
...
async function apiRequest<T>(config: { url: string; method: "GET" | "POST" | "PATCH" | "PUT" | "DELETE"; params?: ApiParams; data?: unknown; headers?: Record<string, string> }) {
    let response;
    try {
